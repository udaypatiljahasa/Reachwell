...
import com.am.reachwell.Global.Helpers.CameraSettingPreferences;
import com.am.reachwell.Global.Helpers.ImageParameters;
import com.am.reachwell.Global.Helpers.ImageUtility;
import com.am.reachwell.Global.Helpers.ResizeAnimation;
import com.am.reachwell.Global.Helpers.SquareCameraPreview;
...
//                .addToBackStack(null)
//                .commit();
        if (mImageParameters.createCopy() == null)
            return;
        Uri photoUri = ImageUtility.savePicture(getActivity(), ImageUtility.rotatePicture(getActivity(), rotation, data));
        setSafeToTakePhoto(true);
